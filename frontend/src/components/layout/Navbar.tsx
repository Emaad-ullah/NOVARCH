...
import { ChevronDown, ArrowRight, Menu, Sun, Moon, Globe, GitBranch, Cpu, Code2 } from 'lucide-react';
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <div className="ml-4 pl-4 border-l border-border flex items-center gap-4">
              <button
                onClick={toggleTheme}
                className="rounded-sm p-2 text-text hover:bg-surface-2 transition-colors cursor-pointer"
                aria-label="Toggle theme"
              >
                {theme === 'dark' ? (
                  <Sun className="h-5 w-5 text-yellow-400" />
                ) : (
                  <Moon className="h-5 w-5 text-[#0D1B2A]" />
                )}
              </button>
              <Link
                href="/contact"
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            >
              {theme === 'dark' ? (
                ...
                <Moon className="h-5.5 w-5.5 text-[#0D1B2A]" />
              )}
            </button>
            <button
